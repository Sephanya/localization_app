...
import 'package:localization_app1/classes/languages.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(getTranslated(context, 'home_page')??'Delete'),
        actions: <Widget>[
          Padding(
      ...
      child: Column(
        children: <Widget>[
          Container(
            ...
            child: Center(
              child: Text(
                getTranslated(context, 'personal_information')??'Delete',
          ...
          MaterialButton(
            ...
            child: Center(
              child: Text(
                getTranslated(context, 'submit_info')??'Delete',
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            title: Text(
              getTranslated(context, 'about_us')??'Delete',
              style: _textStyle,
            ),
            onTap: () {
              // To close the Drawer
          ...
          ListTile(
            ...
            title: Text(
              getTranslated(context, 'settings')??'Delete',
              style: _textStyle,
            ),
            onTap: () {
              // To close the Drawer
